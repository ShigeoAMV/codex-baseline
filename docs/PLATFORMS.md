...
| Native Windows PowerShell 5.1 lifecycle | tested | The pre-provenance-delta payload passes 604 lifecycle assertions under Windows PowerShell 5.1.26100.8875; the final Git-free provenance delta passes 13 focused assertions across PowerShell 5.1 and 7.6.3. Coverage includes exact Owner/DACL protection, restrictive config staging, ADS/reparse, TOML, composite recovery, and release boundaries |
